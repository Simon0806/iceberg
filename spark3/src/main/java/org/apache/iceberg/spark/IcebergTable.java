...
import org.apache.iceberg.spark.source.IcebergMergeBuilder3;
import org.apache.iceberg.spark.source.Spark3IcebergTable;
...
public interface IcebergTable {
  ...
  static IcebergTable of(String tableName) {
    return new Spark3IcebergTable(tableName);
  }
   ...
   * }}}
   */
  IcebergMergeBuilder3 merge(Dataset<Row> source);
}
